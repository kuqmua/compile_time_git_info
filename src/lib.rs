#[proc_macro_derive(CompileTimeGitInfo)]
pub fn derive_compile_time_git_info(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let gen = quote::quote! {
        impl Kekw<'_> {
            pub fn get_git_commit_info<'a>(repo_git_path: &'a str, repo_name: &'a str) -> Kekw<'a> {
                Kekw {
